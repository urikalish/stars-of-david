angular.module('mainApp').factory('people', function people() {
  ...
  return [
    ...
    {name: 'Agam Rudberg'},
    {name: 'Alan Arkin'},
    {name: 'Alanis Morissette', score: 1},
    ...
    {name: 'Ben Shapiro'},
    {name: 'Ben Stiller'},
    {name: 'Benjamin Disraeli', score: 1},
    {name: 'Bette Midler'},
    {name: 'Bill Maher'},
    {name: 'Billy Crystal'},
    {name: 'Billy Joel'},
    ...
    {name: 'Timothée Chalamet', img: 'Timothee_Chalamet'},
    {name: 'Tony Curtis'},
